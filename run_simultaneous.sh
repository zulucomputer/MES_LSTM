...
# jbsub -q x86_6h -cores 1x4+0 -mem 5G -out logs/log_Seychelles.txt python /dccstor/eevdata/mathonsi/tutorials/MES_LSTM/run_multi_MES_LSTM.py  --country 'Seychelles' --thresh 0.45